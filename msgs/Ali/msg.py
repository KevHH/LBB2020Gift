...
def get_msg_list():
    ...
    msg_list.append( Message("-----HELLO!-----", "================", 1) )
    msg_list.append( Message("Thank you", "for LBB!", 1) )
    msg_list.append( Message("Here's a", "scared bot:", 1))

    for i in range(10):
        msg_list.append(Message (" ", " " * i + ".=>.", 0.1))
    msg_list.append(Message (" " * i + "*****"," "*i + ".=>.", 0.5))
    msg_list.append(Message (" " * i + "*****", " "* 7 + "!!.=>.", 0.3))
    for i in range(10): 
        msg_list.append(Message (" "*10 + "*****", " "*(9-i) + ".=>.", 0.1)) 
    
    msg_list.append(Message ("- Ali", " ", 0.8))
