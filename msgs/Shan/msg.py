...
def get_msg_list():
    ...
    msg_list.append( Message("LBB was awesome!", "A huge THANK YOU", 1) )


    # or you can create "animations" like this
    for i in range(9):
        msg_list.append(Message( " " * i + "(*^_^*)", "     Shanice", 0.1)) # iteratively add messages with number of spaces before ^_^ = i
    ########################
    ## CUSTOMISATION END #
    ########################
    return msg_list
