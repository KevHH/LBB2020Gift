...
def get_msg_list():
    ...
    msg_list.append( Message("#No more ", "  black boxes!", 1) )
    msg_list.append( Message("For LBB 2020,", "   we thank you!", 1) )

    # or you can create "animations" like this
    for i in range(8):
        msg_list.append(Message( "▢■" * i + "", "     Ginny", .1)) # iteratively add messages with number of spaces before :) = i
    ########################
    ## CUSTOMISATION END #
    ########################
    return msg_list
